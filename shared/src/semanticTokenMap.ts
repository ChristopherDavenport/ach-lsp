// Semantic token type mapping for ACH fields.
// Shared between the language server and the documentation site viewer.

/** The 8 semantic token type names, indexed by their numeric ID. */
...
/** Map an ach-ts camelCase field name to a semantic token type index. */
export function getTokenType(fieldName: string): number {
